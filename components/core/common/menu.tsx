...
export const Menu = ({
  ...
  return (
    <nav
      className="relative flex justify-center space-x-4 rounded-full border border-transparent bg-white px-8 py-6 shadow-input backdrop-blur-sm dark:border-white/[0.2] dark:bg-neutral-950/30"
